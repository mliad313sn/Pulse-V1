...
async function initDb() {
  ...
  await query(`INSERT INTO schema_migrations (name) VALUES ('001_init.sql'), ('002_ecosystem.sql'), ('003_risk_capa_channels.sql'), ('004_minutes_versions.sql'), ('005_lifecycle.sql'), ('006_workstreams_tasks.sql'), ('007_reminders.sql'), ('008_resources_time.sql'), ('009_finance_benefits.sql'), ('010_portfolio_hierarchy.sql'), ('011_baselines_changes.sql'), ('012_attachments.sql'), ('013_report_dispatch.sql'), ('014_governance_tier.sql') ON CONFLICT DO NOTHING`);
}
