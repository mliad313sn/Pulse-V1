...
async function initDb() {
  await migrate();
  await query(`TRUNCATE webhook_deliveries, webhook_subscriptions, scenarios, cost_plans, project_dependencies, task_baselines, custom_field_defs, project_templates, project_objectives, key_results, objectives, demands, report_dispatch_log, attachments, project_baselines, change_requests, programs, portfolios, strategic_pillars, benefits, budget_lines, time_entries, resource_allocations, reminder_log, task_dependencies, tasks, workstreams, meeting_minutes_versions, notification_deliveries, capas, risks, sync_ops, raci_assignments, deliverables, stage_transitions, audit_log, rag_history, notifications, readiness_items, status_updates,
