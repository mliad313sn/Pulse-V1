...
async function initDb() {
  ...
  await query(`INSERT INTO schema_migrations (name) VALUES ('001_init.sql'), ('002_ecosystem.sql'), ('003_risk_capa_channels.sql'), ('004_minutes_versions.sql'), ('005_lifecycle.sql'), ('006_workstreams_tasks.sql'), ('007_reminders.sql'), ('008_resources_time.sql'), ('009_finance_benefits.sql'), ('010_portfolio_hierarchy.sql') ON CONFLICT DO NOTHING`);
}
