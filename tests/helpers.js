...
async function initDb() {
  await migrate();
  await query(`TRUNCATE audit_log, rag_history, notifications, readiness_items, status_updates,
  ...
  await query(`INSERT INTO schema_migrations (name) VALUES ('001_init.sql') ON CONFLICT DO NOTHING`);
}
